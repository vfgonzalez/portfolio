    ...
    return (
      ...
      <div>
          ...
          <Row s={4} className="valign">
            ...
            <Col l={4}> 
          <Card className='grey' header={<CardTitle reveal image={"./images/projects/slackoverflow2/main.png"} waves='light'/>}
            ...
            <Col l={4}> 
          <Card className='grey' header={<CardTitle reveal image={"./images/projects/slackoverflow1/slackoverflow1.png"} waves='light'/>}
            ...
            <Col l={4}> 
          <Card className='grey' header={<CardTitle reveal image={"./images/projects/enablr/enablr.png"} waves='light'/>}
              title="Enablr"
              reveal={
                <div>
              ...
              <Row>
            <Col offset="m4" l={4}> 
          <Card  className='grey' header={<CardTitle reveal image={"./images/projects/lirinode/lirinode.png"} waves='light'/>}
              title="LIRINode Bot"
              reveal={
                <div>
            ...
            <Col l={4}> 
          <Card className='grey' header={<CardTitle reveal image={"./images/projects/trainschedule/trainschedule.png"} waves='light'/>}
